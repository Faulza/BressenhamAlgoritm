...
{
    awal:cout<<"Inputkan nilai x awal : ";cin>>x1;
    cout<<"Inputkan nilai y awal : ";cin>>y1;
    cout<<"\nMasukkan nilai x akhir : ";cin>>x2;
    cout<<"Masukkan nilai y akhir : ";cin>>y2;
    if((x1 < 0) || (y1 < 0) || (x2 < 0) || (y2 < 0)){
        cout<<"Nilai inputkan ada yang bernilai negatif\n";
        goto awal;
    }
    cout<<endl;
...
void bresenham(void) {
	...
	if(dy>dx){   ///untuk garis yang mendekati vertikal
        ...
        if(y1<y2){
            cout<<"\nMasuk dy dengan y1 lebih kecil\n";
            x = x1;
            xend = x2;
            y = y1;
            yend = y2;
        }else{
            cout<<"\nMasuk dy dengan y2 lebih kecil\n";
            x = x2;
            xend = x1;
            y = y2;
            yend = y1;
        ...
        ///Menentukan titik awal dan akhir
        if(x1<x2){
            cout<<"\nMasuk dx dengan x1 lebih kecil\n";
            x = x1;
            xend = x2;
            y = y1;
            yend = y2;
        }else{
            cout<<"\nMasuk dx dengan x2 lebih kecil x\n";
            x = x2;
            xend = x1;
            y = y2;
            yend = y1;
